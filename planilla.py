...
def app():
    ...
    country = st.sidebar.text_input('Planilla')
    if country != "":
    #SHEET_ID = '12D4hfpuIkT7vM69buu-v-r-UYb8xx4wM1zi-34Fs9ck'
      df = pd.read_csv('https://docs.google.com/spreadsheets/d/'+country+'/export?format=csv')
...
#export_as_pdf = st.button("Export Report")
      ...
      with NamedTemporaryFile(delete=False, suffix=".png") as tmpfile:
            ...
            fig.add_axes(ax)
            tab = plt.table(cellText=table, colWidths=[0.45, 0.25,0.25], colLabels=header, cellLoc='center', loc='center')
            ...
            pdf.image(tmpfile.name, 5, 5, 200, 200)
